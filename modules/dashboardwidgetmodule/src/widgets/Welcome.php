...
namespace modules\dashboardwidgetmodule\widgets;

use modules\dashboardwidgetmodule\DashboardWidgetModule;
use modules\dashboardwidgetmodule\assetbundles\welcomewidget\WelcomeWidgetAsset;
...
class Welcome extends Widget
{
    ...
    {
        return Craft::t('dashboard-widget-module', 'Welcome');
    }
    ...
    {
        return Craft::getAlias("@modules/dashboardwidgetmodule/assetbundles/welcomewidget/dist/img/Welcome-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'dashboard-widget-module/_components/widgets/Welcome_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(WelcomeWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'dashboard-widget-module/_components/widgets/Welcome_body',
            [
