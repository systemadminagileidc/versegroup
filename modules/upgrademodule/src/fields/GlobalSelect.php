...
use modules\upgrademodule\assetbundles\globalselectfield\GlobalSelectFieldAsset;
 ...
 * @since     1.0.0
 */
class GlobalSelect extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('upgrade-module', 'GlobalSelect');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'upgrade-module/_components/fields/GlobalSelect_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(GlobalSelectFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').UpgradeModuleGlobalSelect(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'upgrade-module/_components/fields/GlobalSelect_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
